...
description: "YouTube 등 자막이 있는 영상 URL에서 자막(업로드/자동 생성)을 내려받아 마크다운 파일을 생성하는 스킬. 사용 시점 - (1) YouTube 영상 내용을 빠르게 문서화할 때, (2) 영상 콘텐츠를 마크다운으로 검색 가능하게 만들 때, (3) 강의/튜토리얼 요약을 만들 때. yt-dlp 자막 기반이라 Whisper 같은 STT를 돌리지 않고 빠르게 처리됨."
license: Proprietary
---

# Video Transcript 스킬

YouTube 등에서 **yt-dlp**로 자막(업로드된 자막 우선, 없으면 자동 생성 자막)을 내려받아 마크다운으로 저장합니다. **Whisper를 사용하지 않습니다.**
